...
@SpringBootTest
public class BonusPointsDiscountsControllerTest {

	private static final String URL_PREFIX = "/api/purchases/bonusPoitsDiscounts";
	...
	public void testSave() throws Exception{
		...
		String json = "{ \"id\" : -1, \"discount\" : 20, \"points\" : 5 }";
